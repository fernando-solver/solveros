...
> "Gerei o ZIP, mas detectei possiveis credenciais nos seguintes arquivos: `scripts/oracle_conn.py` (SENHA), `scripts/integrar.py` (API_KEY). Elas foram substituidas por [REDACTED-*] nos arquivos texto, mas recomendo uma olhada antes de enviar."
